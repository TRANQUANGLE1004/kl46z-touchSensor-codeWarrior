...
**     Date/Time   : 2019-07-11, 01:53, # CodeGen: 30
**     Contents    :
...
byte TSS1_Configure(void)
{
  ...
  u8Result |= TSS_SetASliderConfig(TSS1_cKey0.ControlId, ASlider_Range_Register, 0xFA);
  /* Configure ASlider Control configuration registers */
  u8Result |= TSS_SetASliderConfig(TSS1_cKey0.ControlId, ASlider_ControlConfig_Register, TSS_ASLIDER_CONTROL_EN_MASK | TSS_ASLIDER_CALLBACK_EN_MASK | 0x00);
